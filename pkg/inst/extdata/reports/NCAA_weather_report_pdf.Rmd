...
input_data <- create_weather_starting.table(variable = c("temp", "rain"),
...
knitr::include_graphics(path = here::here(c("assets/acacia_close_small.jpg", "assets/ngoitokitok_close_small.jpg")),
                        auto_pdf = TRUE)
```
